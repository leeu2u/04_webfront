...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    //#li1의 부모노드의 마지막 부분에 "ABCD"라는 text node추가
...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    console.log(list); // HTMLCollection 형태로 반환
    ...
    // const i = Document.getElementById("test").children[2].previousElementsSibling;
    ...
    list[2].previousElementSibling.addEventListener("click", function(){
        ...
        alert(this.innerText);
            ...
            // 이벤트가 발생한 요소의 다음 다음 형제의 요소의 배경색을 red로 변경
...
btn4.addEventListener("click", function(){
    if(count4 <= 10){
        ...
        // 요소.append(노드 또는 요소)
        //-> 요소의 마지막 자식으로 추가
        div.append(input) //==<input type ='text'/>
